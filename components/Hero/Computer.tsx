...
function Computer({}: Props) {
  return (
    <div className='absolute bottom-0 left-56 w-96 z-0  hiddenHeight'>
        <div>
            <div className='flex'>
                <div className='flex flex-col justify-between align-items'>
                    <div className='flex relative'>
                        ...
                        <div className='bg-black h-40 w-[78px] ml-[7px] gradient-border rounded-r-sm flex items-center justify-center'>
                            <img src={"https://img.icons8.com/color/480/razer.png"} className="w-4 mb-24 brightness-200 animate-pulse" alt="Razer Logo" />
                        </div>
                    </div>
                ...
                <div className='flex flex-col justify-center relative items-center'>
                    <div className='border-[7px] border-black w-[320px] h-32 ml-[80px] bg-black z-20 mb-8 rounded-sm'>
                        <img src="coding.png" className='object-cover h-full w-full' alt="VSCode image"/>
                    </div>
